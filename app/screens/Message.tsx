...
const Message = () => {
  ...
  const [messages, setMessages] = useState([
    ...
    { id: "10", text: "Yes, I'm really looking forward to it.", sender: "other" },
    ...
    { id: "14", text: "We should go to a concert together sometime.", sender: "other" },
  ...
  const sendMessage = () => {
    if (newMessage.trim() !== '') {
      const newMessageObj = { id: toString(messages.length + 1), text: newMessage, sender: 'user' };
